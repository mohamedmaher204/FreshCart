...
import { loginSchema, LoginInput } from '@/app/_lib/validations'
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 bg-gray-50/50 dark:bg-zinc-950 transition-colors duration-500">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-xl shadow-emerald-900/5 dark:shadow-none border border-gray-100 dark:border-zinc-800 p-8 md:p-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black text-gray-900 dark:text-zinc-100">Welcome Back</h1>
          <p className="text-gray-500 dark:text-zinc-500 text-sm mt-1">Please enter your details to log in</p>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Field data-invalid={fieldState.invalid}>
                ...
                <div className="relative group">
                  ...
                  <Input
                    {...field}
                    type="email"
                    className="h-14 pl-11 rounded-xl bg-gray-50 dark:bg-zinc-800 border-transparent focus:bg-white dark:focus:bg-zinc-800 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-lg dark:text-zinc-100"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-14 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg shadow-emerald-200 dark:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2"
          >
